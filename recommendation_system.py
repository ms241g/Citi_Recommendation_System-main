...
def load_csv():
    ...
    reader = pd.read_csv('C:/Demo/Bank Recommender System/Hybrid_Recommendation_System-main/df_train_small.csv', chunksize=1e6,
...
def recommendation(user_id, df, hybrid_outcome):
    ...
    return change_names(list(recom_sort.keys()))[:3]
